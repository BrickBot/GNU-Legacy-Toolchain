...
extern const struct ggc_root_tab gt_ggc_r_gt_cil_cil_lang_h[];
extern const struct ggc_root_tab gt_ggc_r_gt_cil_cil_builtins_h[];
extern const struct ggc_root_tab gt_ggc_r_gt_cil_bindings_h[];
extern const struct ggc_root_tab gt_ggc_r_gt_cil_parser_h[];
extern const struct ggc_root_tab gt_ggc_r_gt_cil_stack_h[];
const struct ggc_root_tab * const gt_ggc_rtab[] = {
  ...
  gt_ggc_r_gt_cil_cil_lang_h,
  gt_ggc_r_gt_cil_cil_builtins_h,
  gt_ggc_r_gt_cil_bindings_h,
  gt_ggc_r_gt_cil_parser_h,
  gt_ggc_r_gt_cil_stack_h,
  NULL
};
